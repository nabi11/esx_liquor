...
ESX.RegisterServerCallback('esx_liquor:requestDBItems', function(source, cb)
...
RegisterServerEvent('esx_liquor:buyItem')
AddEventHandler('esx_liquor:buyItem', function(itemName, price)
